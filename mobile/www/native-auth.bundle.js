  ...
  if (Capacitor.isNativePlatform()) {
    document.addEventListener("click", async (event) => {
      ...
      try {
        ...
        if (!idToken) throw new Error("Firebase kh\xF4ng tr\u1EA3 v\u1EC1 ID token.");
        ...
        if (!response.ok) throw new Error(data.message || "Kh\xF4ng \u0111\u0103ng nh\u1EADp \u0111\u01B0\u1EE3c v\xE0o Gusa Quy Trinh.");
